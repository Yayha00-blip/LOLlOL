...
const products = [
  { name: 'Chambray bleu', price: '950 MAD', image: '/images/3.jpg' },
  { name: 'Coton souple beige', price: '910 MAD', image: '/images/2.jpg' },
  { name: 'Rayure casual', price: '930 MAD', image: '/images/1.jpg' },
]
      ...
      >
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          >
            Plus libre,
            <br />
            <em style={{ color: 'var(--gold)', fontStyle: 'italic' }}>toujours juste</em>
          </h1>
          ...
          >
            Une collection plus souple et décontractée, pensée pour le week-end,
            les journées informelles et un vestiaire plus spontané.
          </p>
        </div>
      </section>
